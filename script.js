document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectData = {
        ...
        'DevOps Pipeline Monitor': {
            ...
            tags: ['React', 'FastAPI', 'Docker', 'WebSockets', 'Python'],
            desc: `
                <p>A real-time DevOps dashboard that monitors GitHub Actions CI/CD pipelines with live WebSocket updates and system-level metrics.</p>
                <br>
                <p><strong>Key Features:</strong></p>
                <ul>
                    <li>Live pipeline status via WebSocket connections</li>
                    <li>System metrics (CPU, memory, disk) dashboard</li>
                    <li>FastAPI backend containerized with Docker</li>
                    <li>React frontend with real-time data visualization</li>
                </ul>
                <br>
                <p><a href="https://github.com/RBKesh/devops-pipeline-monitor" target="_blank" style="color: var(--accent-color);">View on GitHub →</a></p>
            `
        }
    };
